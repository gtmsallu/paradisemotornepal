        ...
        <div className="col-md-7 ms-md-4">
          ...
          <form method="POST" className="contact-form px-lg-4 py-3">
            ...
            <div className="form-group">
              ...
              <textarea name="message" id="inputAddress" className="form-control" rows="3" name="message" onChange={inputValue} value={userData.message} placeholder="write your message here..." required></textarea>
            </div>
